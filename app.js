...
function displayCards(cards){
    ...
    console.log($card1)
    $bundle1.append(eachCard(cards, "1", $card1)) 
    $bundle2.append(eachCard(cards, "2", $card2)) 
    $bundle3.append(eachCard(cards, "3", $card3)) 
...
function eachCard(card, $bundle, $cardID){
    ...
    bundleCard($chosenCard[0].name, $chosenCard[0].desc, $chosenCard[0].image)
...
function bundleCard(name, desc, image){
    ...
    // $bundleTag.append($thefront,$theback)
